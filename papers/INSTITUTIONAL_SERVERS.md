...
2. **Be precise about what is stale.** The defensible claim is that the *documentation and workflow* are dated — CSN's current manual is Version 2017-08-05 and its CIT web materials are frozen at 2015–2018; UNLV's public CS 370 record has not been touched since January 2017 and still names a decommissioned server as the course environment — while the servers themselves are not provably neglected (bellagio runs patched Ubuntu 22.04; sally received an upgrade as late as September 2020), and the CS 218 textbook is genuinely maintained (v1.1.58, September 2024, targeting Ubuntu 22.04). Avoid asserting that either school ran unpatched servers.
